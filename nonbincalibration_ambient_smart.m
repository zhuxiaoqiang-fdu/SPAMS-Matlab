...
xlswrite('aveMMatpcal_ambient_smart_noncalibration.xlsx',aveMMatpcal);
xlswrite('positive_slope_smart_noncalibration.xlsx',ps);
xlswrite('negative_slope_smart_noncalibration.xlsx',pps);
